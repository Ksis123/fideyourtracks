        ...
        <div className="profile-holder">
          <div className="profile-div">
            ...
            >
              ...
              <div className="gap-5 flex">
                <Form.Item className=" text-[#ffffff]" label="First Name" name="firstname" rules={antValidationError}>
                  <input className="profileinput" />
                </Form.Item>
                <Form.Item className=" text-[#ffffff]" label="Last Name" name="lastname" rules={antValidationError}>
                  <input className="profileinput" />
                </Form.Item>
              </div>

              <div className="gap-5 flex">
                <Form.Item className=" text-[#ffffff]" label="Artist-Type" name="type" rules={antValidationError}>
                ...
                <Form.Item className=" text-[#ffffff]" label="Nation" name="nation" rules={antValidationError}>
                  <select className="profileinput overflow-y-scroll">
                    <option value="">--- select one ---</option>
